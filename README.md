...
(You can try it [here](http://instaparse-live.matt.is))
 ...
 When I started working with Instaparse I knew nothing about writing a parser, but I was excited about possibilities. As a complete beginner, I made frequent mistakes and wanted faster feedback as I tried to develop an intuition for the problem, so I made a quick instant-preview tool that I found useful. After [asking](https://twitter.com/mhuebert/status/603234544679047168) the creator of instaparse-cljs if this had been done before, I decided to build the more polished version that you are now visiting.
